...
<head>
    ...
    <title>Login - Dukcapil Admin Dashboard</title>
    
    
    
    <link rel="shortcut icon" href="./assets/compiled/svg/dukcapil.svg" type="image/x-icon">
...
<div class="row h-100">
    <div class="col-lg-5 col-12">
        <div id="auth-left">
            ...
            <p class="auth-subtitle mb-5">Silahkan Masukkan Email dan Password Admin</p>
    ...
    <div class="col-lg-7 d-none d-lg-block d-flex">
        <div id="auth-right" class="text-center">
            <img src="./assets/compiled/svg/dukcapil.svg" style="align-items: center; margin-top:200px;" alt="">
        </div>
    </div>        
</div>
